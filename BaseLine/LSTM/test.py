...
lstm_model.load_state_dict(torch.load('best_lstm_model/best_lstm_model.pth'))
logger.info("Loaded model: best_lstm_model/best_lstm_model.pth")
lstm_model.to(device)

# 使用测试集进行评估


test_loss, rmse, mae, r2, metrics = test_downstream(lstm_model, test_loader, device)
